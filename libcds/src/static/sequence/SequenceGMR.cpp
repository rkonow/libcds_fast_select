...
SequenceGMR::SequenceGMR(uint *sequence, size_t n, uint chunk_length, BitSequenceBuilder *bmb, SequenceBuilder *ssb)
        : Sequence(n) {
    bmb->use();
    ssb->use();
    length = n;
...
SequenceGMR::SequenceGMR(const Array &sequence, uint chunk_length, BitSequenceBuilder *bmb, SequenceBuilder *ssb)
        : Sequence(0) {
    bmb->use();
    ssb->use();
