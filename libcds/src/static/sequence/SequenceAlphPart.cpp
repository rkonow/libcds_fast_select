...
SequenceAlphPart::SequenceAlphPart(const Array &seq, uint _cut, SequenceBuilder *lenIndexBuilder, SequenceBuilder *seqsBuilder)
        : Sequence(0) {
...
SequenceAlphPart::SequenceAlphPart(uint *seq, size_t n, uint cut, SequenceBuilder *lenIndexBuilder, SequenceBuilder *seqsBuilder)
        : Sequence(n) {
