...
SequenceGMRChunk::SequenceGMRChunk(uint *sequence, uint chunk_length, BitSequenceBuilder *bmb, PermutationBuilder *pmb)
        : Sequence(chunk_length) {
    pmb->use();
    bmb->use();
    sigma = 0;
...
SequenceGMRChunk::SequenceGMRChunk(const Array &sequence, BitSequenceBuilder *bmb, PermutationBuilder *pmb)
        : Sequence(0) {
    pmb->use();
    bmb->use();
